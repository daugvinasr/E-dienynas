                ...
                <div class="flex space-x-56 justify-center">
                    ...
                    <div>
                        <div class="mb-4">
                            ...
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="Tevu_Numeris" type="text">
                        </div>
                        <div class="mb-4">
                            <label class="block text-gray-700 text-sm font-bold mb-2">
                                Tevų adresas
                            </label>
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="Tevu_Adresas" type="text">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="Ar_Seniunas" type="range" min="0" max="1" value="0">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" name="Ar_Pavaduotojas" type="range" min="0" max="1" value="0">
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <select name="fk_Klase">
                                @foreach($klaseData as $data)--}}
                                <option value="{{$data->id_Klase}}">{{$data->Pavadinimas}}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
